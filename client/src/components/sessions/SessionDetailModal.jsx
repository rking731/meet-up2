        ...
        <div className='p-6 border-b border-slate-100 flex items-center justify-between'>
          <div>
            <div className='flex items-center gap-2'>
              <span className='text-xs font-mono text-slate-700 font-medium bg-slate-100 px-2 py-0.5 rounded-md'>ID: {session.meetingId}</span>
              <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${isEnded ? "bg-slate-100 text-slate-600" : "bg-emerald-50 text-emerald-700"}`}>
